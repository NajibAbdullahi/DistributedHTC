...
import sys
y_test_pred = pd.read_csv('/home/ubuntu/DistributedHTC/Evalaution/LogisticRegression/y_pred_test.csv')
...
cm.to_csv('/home/ubuntu/DistributedHTC/Evalaution/LogisticRegression/cm.csv', index=False)

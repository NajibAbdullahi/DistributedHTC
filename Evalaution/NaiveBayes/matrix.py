...
import sys
y_test_pred = pd.read_csv('/home/ubuntu/DistributedHTC/Evalaution/NaiveBayes/y_pred_test.csv')
...
cm.to_csv('/home/ubuntu/DistributedHTC/Evalaution/NaiveBayes/cm.csv', index=False)

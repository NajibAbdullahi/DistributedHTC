...
with open ('/home/ubuntu/DistributedHTC/Evalaution/rf_model_metrics.csv','w',encoding='UTF-8') as f:
    writer = csv.writer(f)
...
y_pred_test_.to_csv(
    '/home/ubuntu/DistributedHTC/Evalaution/RandomForest/y_pred_test.csv', index=False)
